DROP DATABASE IF EXISTS libreria-curso-de-mysql-platzi;

CREATE DATABASE libreria-curso-de-mysql-platzi;
USE libreria-curso-de-mysql-platzi;
...
insert into transactions(client_id, book_id, estate, finished) values(34, 12, 'sell',1);
insert into transactions(client_id, book_id, estate, finished) values(87, 54, 'lend',0);
insert into transactions(client_id, book_id, estate, finished) values(14, 3, 'sell',1);
insert into transactions(client_id, book_id, estate, finished) values(54, 1, 'sell',1);
insert into transactions(client_id, book_id, estate, finished) values(81, 12, 'lend',1);
insert into transactions(client_id, book_id, estate, finished) values(81, 12, 'sell',1);
insert into transactions(client_id, book_id, estate, finished) values(30, 10, 'return',1);